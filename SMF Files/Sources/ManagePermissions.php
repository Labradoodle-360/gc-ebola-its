...
function ModifyPermissions()
{
	...
	//-- Greenville College; Ebola Effort
	//-- Matthew Kerle - 10/09/2014
	loadLanguage('Ebola/Primary');
	// End Greenville College; Ebola Effort --//
...
function loadAllPermissions()
{
	...
	*/
	$permissionList = array(
		'membergroup' => array(
			//-- Greenville College; Ebola Effort
			'ebola_view_dashboard' => array(false, 'ebola'),
			'ebola_view_quizzes' => array(false, 'ebola'),
			'ebola_add_modify_quizzes' => array(false, 'ebola'),
			'ebola_add_modify_categories' => array(false, 'ebola'),
			'ebola_add_modify_questions' => array(false, 'ebola'),
			'ebola_export_quizzes' => array(false, 'ebola'),
			// End Greenville College; Ebola Effort --//
